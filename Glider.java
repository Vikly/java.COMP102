...
public class Glider{
   ...
   double x=0;
    ...
    /**
        ...
        */
    public void draw(){
           double yPosition = FLOOR-height;
            /*# YOUR CODE HERE */ 
            UI.drawImage("glider.png",x,yPosition);
    ...
    public double getX(){
           ...
           return this.x;   //This is wrong!! but it will make the code compile until you replace it.
    }
    ...
    public double getHeight(){
           ...
           return this.height;   //This is wrong!! but it will make the code compile until you replace it.
    }
